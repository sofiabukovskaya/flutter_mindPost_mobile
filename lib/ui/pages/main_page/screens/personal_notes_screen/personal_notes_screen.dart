...
var fire;
  ...
  getId() async {
    ...
    setState(() {
      ...
      fire =  FirebaseFirestore.instance.collection('notes').where('userId', isEqualTo: token).snapshots();
    });
  }
  @override
        ...
        body: StreamBuilder(
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
           ...
           return SingleChildScrollView(
            ...
            top: 20,
            left: 150,
            child: Text('${snapshot.data.docs[index]['publish'].toString()}',
            style: GoogleFonts.poppins(
            fontSize: 18,
            ...
            height: 150,
            width: 200,
            child: Text('${snapshot.data.docs[index]['description'].toString()}',
            maxLines: 2,
            ...
            top: 60,
            left: 300,
            child: public == true ? Icon(Icons.lock_open, color: Colors.black38,) : Icon(Icons.lock_outline, color: Colors.black38,)
            )
            ],
            ),
